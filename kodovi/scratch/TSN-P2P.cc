...
NS_LOG_COMPONENT_DEFINE("Tsn-example");
...
int main(int argc, char *argv[])
{
  ...
  simulationDuration = 3 * scheduleDuration * NUMBER_OF_SCHEDULE_ENTRYS;
  ...
  mob0->SetPosition(Vector(10.0, 20.0, 0.0));
  mob1->SetPosition(Vector(50.0, 20.0, 0.0));
  ...
  pointToPoint.EnablePcapAll("TSN-P2P");

  AnimationInterface anim("TSN-P2P.xml");
