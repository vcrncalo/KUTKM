...
int main(int argc, char *argv[]) {
	...
	// ON/OFF pattern
	for (int i = 0; i < 5; i++) {
    	  schedulePlanClient.Add(scheduleDuration,{1,0,1,0,1,0,1,0});
    ...
    beClient.SetAttribute("PacketSize", UintegerValue(256));
    ...
    // NetAnim
    AnimationInterface anim("TSN3.xml");
    ...
    pointToPoint.EnablePcapAll("TSN3_packet_trace");
